...
BEGIN
	...
	VALUES
	('9781234567890', 'Sample Book 1', get_random_author_id(), 2022, 'Fiction', 300, 'English'),
	('9782345678901', 'Sample Book 2', get_random_author_id(), 2020, 'Mystery', 250, 'Spanish'),
	('9783456789012', 'Sample Book 3', get_random_author_id(), 2019, 'Science Fiction', 400, 'French'),
	('9784567890123', 'Sample Book 4', get_random_author_id(), 2021, 'Romance', 350, 'German'),
	('9785678901234', 'Sample Book 5', get_random_author_id(), 2018, 'Thriller', 320, 'Italian'),
	('9786789012345', 'Sample Book 6', get_random_author_id(), 2023, 'Fantasy', 280, 'Portuguese'),
	('9787890123456', 'Sample Book 7', get_random_author_id(), 2017, 'Historical Fiction', 420, 'Russian'),
	('9788901234567', 'Sample Book 8', get_random_author_id(), 2020, 'Biography', 300, 'Chinese'),
	('9789012345678', 'Sample Book 9', get_random_author_id(), 2019, 'Comedy', 350, 'Japanese'),
	('9780123456789', 'Sample Book 10', get_random_author_id(), 2021, 'Drama', 320, 'Arabic'),
